...
# Se quiere implementar un conversor de unidades de temperatura para convertir valores(float)
# entre las unidades Fahrenheit, Celsius y Kelvin (identificadas con los caracteres 'F', 'C' y 'K')
# el conversor debe manejar los casos en que la temperatura no sea físicamente realizable (< 0 K)
...
# - Si la unidad de temperatura original es la misma a la que se quiere convertir, se devuelve el mismo valor sin modificar.

#FÓRMULAS:
#   T_K = T_C + 273.15
#   T_K = (T_F + 459.67)*5/9

# Se definen los siguientes métodos para el Conversor:
...
if __name__ == '__main__':
    ...
    miConversor = ConversorUnidadesTemperatura()
    print(miConversor.convertir_unidades_temperatura(-200, 'C', 'K'))   
